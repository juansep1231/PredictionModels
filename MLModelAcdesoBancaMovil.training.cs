...
namespace DashboardModels
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\OMEN\Documents\Produbanco\datosbancamovil.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.ConvertType(new []{new InputOutputColumnPair(@"Fecha", @"Fecha"),new InputOutputColumnPair(@"Hora", @"Hora")})      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Fecha",@"Hora"}))      
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=56,MinimumExampleCountPerLeaf=26,NumberOfTrees=919,MaximumBinCountPerFeature=969,FeatureFraction=0.8271630453987685,LearningRate=0.19032562709438092,LabelColumnName=@"Numero",FeatureColumnName=@"Features",DiskTranspose=false}));
