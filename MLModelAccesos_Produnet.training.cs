...
{
    public partial class MLModelAccesos_Produnet
    {
        public const string RetrainFilePath =  @"C:\Users\shotweif Geng\Desktop\Accesos_Produnet.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"Time", @"Time", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LbfgsPoissonRegression(new LbfgsPoissonRegressionTrainer.Options(){L1Regularization=0.09989145F,L2Regularization=0.24304603F,LabelColumnName=@"Numero",FeatureColumnName=@"Features"}));
