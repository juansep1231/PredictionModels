...
{
    public partial class MLModelTarjetasDebito
    {
        public const string RetrainFilePath =  @"C:\Users\OMEN\Documents\Produbanco\traejtasdebito.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Fecha",outputColumnName:@"Fecha")      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options(){NumberOfLeaves=382,MinimumExampleCountPerLeaf=5,NumberOfTrees=456,MaximumBinCountPerFeature=645,FeatureFraction=0.6128501358984992,LearningRate=0.11916960042752817,LabelColumnName=@"Numero",FeatureColumnName=@"Features",DiskTranspose=false}));
