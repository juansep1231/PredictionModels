...
{
    public partial class MLModelAccesosBancaMovil
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Fecha",outputColumnName:@"Fecha")      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LbfgsPoissonRegression(new LbfgsPoissonRegressionTrainer.Options(){L1Regularization=1.958921F,L2Regularization=2.287998F,LabelColumnName=@"Numero",FeatureColumnName=@"Features"}));
