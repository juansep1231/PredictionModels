...
{
    public partial class MLModel_DebitoActualizado
    {
        public const string RetrainFilePath =  @"C:\Users\OMEN\Documents\Produbanco\debito_actualizado.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Fecha",outputColumnName:@"Fecha")      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LbfgsPoissonRegression(new LbfgsPoissonRegressionTrainer.Options(){L1Regularization=76.00734F,L2Regularization=81.38879F,LabelColumnName=@"Numero",FeatureColumnName=@"Features"}));
